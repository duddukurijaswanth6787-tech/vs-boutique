...
export default function ReturnRequestModal({ visible, onClose, onSubmit, saving }) {
  ...
  return (
    <Modal isOpen={visible} onClose={onClose} title="Request Return">
      <div className="text-center mb-6">
        ...
        <p className="text-xs text-gray-400 mt-1">Tell us why you're returning this item</p>
      </div>
