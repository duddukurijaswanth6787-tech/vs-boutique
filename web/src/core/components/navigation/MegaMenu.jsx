...
export const MegaMenu = () => {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold uppercase tracking-wider text-gray-700 hover:text-accent rounded-xl hover:bg-accent/5 transition-all focus:outline-none cursor-pointer"
      >
        <span>Shop</span>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute left-0 top-full mt-2 w-[700px] bg-white dark:bg-gray-900 rounded-3xl shadow-premium border border-[#d2c5b1]/15 p-6 z-50"
          >
